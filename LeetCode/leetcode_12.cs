...
namespace LeetCode
{
    public class leetcode_12
    {
        ...
        {
            /*var dic1 = new Dictionary<int, string> { { 1, "I" }, { 2, "II" }, { 3, "III" }, { 4, "IV" }, { 5, "V" }, { 6, "VI" }, { 7, "VII" }, { 8, "VIII" }, { 9, "IV" }, { 0, "" } };
            ...
            return dic1000[num / 1000] + dic100[num / 100 % 10] + dic10[num / 10 % 10] + dic1[num % 10];*/
